...
Para permitir que los equipos cliente informen detalles de compatibilidad con BitLocker a través de los informes de MBAM Configuration Manager, tiene que editar el archivo **Configuration. mof** , ya sea que use SystemCenter2012 ConfigurationManager o el administrador de configuración 2007. Complete las siguientes instrucciones para la versión de Configuration Manager que está usando.

...
Agrega un registro de aplicación.
...
<tr class="even">
<td align="left"><p>/OSD &lt; OSD-nombreruta&gt;</p></td>
<td align="left"><p>La ruta de acceso o la dirección URL del archivo OSD.</p></td>
</tr>
<tr class="odd">
...
**Nota:**  El nombre resultante de la aplicación se tomará del archivo OSD y no del nombre proporcionado en APP: &lt; Application &gt; .

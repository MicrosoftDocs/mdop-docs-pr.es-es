...
Puede crear la imagen de recuperación de Microsoft Diagnostics and Recovery Toolset (DaRT) 10 con un script de PowerShell en lugar de usar el Asistente de imagen de recuperación de DaRT 10. Consulte la siguiente secuencia de comandos de ejemplo.

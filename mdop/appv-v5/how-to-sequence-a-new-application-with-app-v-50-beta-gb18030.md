...
4.  Revise los siguientes elementos:
    ...
    -   A partir de App-V 5,0 SP3, el directorio principal de la aplicación virtual (PVAD) está oculto, pero puede volver a activarlo. Consulte [acerca de App-V 5,0 SP3](about-app-v-50-sp3.md#bkmk-pvad-hidden).
...
6. En la página **nombre del paquete** , escriba un nombre que se asociará con el paquete. Use un nombre que le ayude a identificar el propósito y la versión de la aplicación que se agregará al paquete. El nombre del paquete se muestra en la consola de administración de App-V 5,0.
   ...
   El **directorio principal de la aplicación virtual** muestra la ruta en la que se instalará la aplicación en los equipos de destino. Para especificar esta ubicación, seleccione **examinar**.
...
7. En la página **nombre del paquete** , escriba un nombre que se asociará con el paquete. Use un nombre que le ayude a identificar el propósito y la versión de la aplicación que se agregará al paquete. El nombre del paquete aparecerá en la consola de administración de App-V 5,0. El **directorio principal de la aplicación virtual** muestra la ruta en la que se instalará la aplicación. Para especificar esta ubicación, escriba la ruta de acceso o haga clic en **examinar**.
...
6. En la página **nombre del paquete** , escriba un nombre que se asociará con el paquete. Use un nombre que le ayude a identificar el propósito y la versión de la aplicación que se agregará al paquete. El nombre del paquete se muestra en la consola de administración de App-V 5,0. El **directorio principal de la aplicación virtual** muestra la ruta en la que se instalará la aplicación. Para especificar esta ubicación, escriba la ruta de acceso o haga clic en **examinar**.

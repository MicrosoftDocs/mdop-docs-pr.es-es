...
Use el siguiente procedimiento para instalar el servidor de Microsoft Application Virtualization (App-V) 5,1. Para obtener información sobre cómo implementar el servidor de App-V 5,1, consulte [acerca de App-v 5,1](about-app-v-51.md#bkmk-migrate-to-51).

**Antes de empezar:**

-   Asegúrese de que ha instalado el software necesario. Consulte [requisitos previos de App-V 5,1](app-v-51-prerequisites.md).

-   Revise la sección de servidor de [consideraciones de seguridad de App-V 5,1](app-v-51-security-considerations.md).
...
-   Si usa secuencias de comandos SQL, en lugar de Windows Installer, para configurar la base de datos de administración o la base de datos de informes, debe ejecutar las secuencias de comandos SQL antes de instalar el servidor de administración o el servidor de informes. Vea [cómo implementar las bases de datos de App-V con scripts SQL](how-to-deploy-the-app-v-databases-by-using-sql-scripts51.md).

**Para instalar el servidor de App-V 5,1**

1. Copie los archivos de instalación de App-V 5,1 Server en el equipo en el que desea instalarlo.

2. Para iniciar la instalación del servidor de App-V 5,1, haga clic con el botón secundario en **appv\_server\_setup.exe** como administrador y, a continuación, haga clic en **instalar**.
...
4. En la página **selección de características** , seleccione todos los componentes siguientes.
   ...
   <td align="left"><p>Proporciona App-V 5,1 Reporting Services.</p></td>
   </tr>
   <tr class="odd">

...
-   Asegúrese de que ha instalado el secuenciador Microsoft Application Virtualization (App-V), que es necesario para modificar un paquete de aplicaciones virtual. Para instalar el secuenciador de App-V, vea [Cómo instalar el secuenciador](how-to-install-the-sequencer-51beta-gb18030.md).
...
5.  En la consola del secuenciador de App-V, realice cualquiera de las siguientes tareas según sea necesario:
    ...
    -   Importar o exportar un archivo VFS.

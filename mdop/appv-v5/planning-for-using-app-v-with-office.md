...
Use la siguiente información para planear cómo implementar Office con App-V. Este artículo incluye:
...
En la siguiente tabla se enumeran las versiones de Microsoft Office compatibles con App-V, los métodos de creación de paquetes de Office, las licencias admitidas y las implementaciones admitidas.
...
<thead>
<tr class="header">
<th align="left">Versión de Office compatible</th>
<th align="left">Versiones de App-V compatibles</th>
<th align="left">Creación de paquetes</th>
<th align="left">Licencias admitidas</th>
<th align="left">Implementaciones admitidas</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><p>Aplicaciones de Microsoft 365 para empresas</p>
<p>También se admiten:</p>
<ul>
...
<td align="left"><p>Herramienta de implementación de Office</p></td>
<td align="left"><p>Suscripción</p></td>
<td align="left"><ul>
<li><p>Escritorio</p></li>
<li><p>VDI personal</p></li>
<li><p>VDI agrupada</p></li>
<li><p>RDS</p></li>
</ul></td>
</tr>
<tr class="even">
...
2.  Para iniciar el editor del registro, haga lo siguiente:
    ...
    -   En Windows 8, escriba **regedit** y presione Entrar en la página de inicio y, a continuación, presione Entrar.

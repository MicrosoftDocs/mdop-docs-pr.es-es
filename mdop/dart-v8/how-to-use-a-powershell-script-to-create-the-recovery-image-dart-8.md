...
---
# Cómo usar un script de PowerShell para crear la imagen para recuperación


## <a href="" id="bkmk-create-image-use-script"></a>Para crear la imagen de recuperación de DaRT mediante un script de PowerShell


Puede crear la imagen de recuperación de Microsoft Diagnostics and Recovery Toolset (DaRT) 8,0 mediante un script de PowerShell en lugar de usar el Asistente de imagen de recuperación de DaRT 8,0. Consulte la siguiente secuencia de comandos de ejemplo.
...
`Import-Module "Dism"`Operaciones`mport-Module "Microsoft.Dart"`

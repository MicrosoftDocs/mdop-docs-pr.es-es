...
ms.locfileid: "10822890"
---
# <span data-ttu-id="97ed2-103">Cómo usar un script de PowerShell para crear la imagen para recuperación</span><span class="sxs-lookup"><span data-stu-id="97ed2-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="97ed2-104">Para crear la imagen de recuperación de DaRT mediante un script de PowerShell</span><span class="sxs-lookup"><span data-stu-id="97ed2-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="97ed2-105">Puede crear la imagen de recuperación de Microsoft Diagnostics and Recovery Toolset (DaRT) 8,0 mediante un script de PowerShell en lugar de usar el Asistente de imagen de recuperación de DaRT 8,0.</span><span class="sxs-lookup"><span data-stu-id="97ed2-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="97ed2-106">Consulte la siguiente secuencia de comandos de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="97ed2-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="97ed2-107">Operaciones</span><span class="sxs-lookup"><span data-stu-id="97ed2-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="97ed2-108">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="97ed2-108">Related topics</span></span>


[<span data-ttu-id="97ed2-109">Administración de DaRT 8.0 mediante PowerShell</span><span class="sxs-lookup"><span data-stu-id="97ed2-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
